...
public class EnemyShipFactory {
    ...
    public EnemyShipFactory(int maxShips, CollisionDetector collisionDetector, GameMap gameMap) {
    ...
    public void init() {
        ...
        for (int i = 0; i < maxShips; i++) {
            ...
            EnemyShip enemyShip = new EnemyShip(x, y, collisionDetector, gameMap);
